...
# file_path = "/usr/Hadoop/twitter_data/FlumeData.1600985410775"
file_path = "/usr/Hadoop/twitter_data/FlumeData.1600985007903"
# FlumeData.1600985410775
...
for msg in twitter_data_json:
    try:
        ...
        if msg_dict_filt != 'null':
            producer.send('twitter-topic',json.dumps(msg_dict_filt).encode('utf-8'))
